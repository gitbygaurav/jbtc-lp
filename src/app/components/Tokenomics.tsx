    ...
    <div className="w-full max-w-[1440px] mx-auto py-6 md:py-16 px-2 md:px-8">
        ...
        <div className="flex flex-col justify-between px-5 md:px-10 py-8 md:py-12">
          ...
          <div>
            <div>
              ...
              <p className="text-white text-xl md:text-3xl font-bold">JBTC</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-bold">21,000,000</p>
                ...
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-bold">1,000,000</p>
                ...
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-bold">45yrs</p>
              ...
              <div>
                <div className="md:mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-bold">BSC</p>
                ...
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-bold">20,000,000</p>
                    <p className="text-[#CFDCE5] ">JBTC</p>
                  </span>
                </div>
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-bold">5,000 </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-6">
        <div className="bg-white rounded-xl p-6 rounded-shadow border border-[#CFDCE5]">
          <h3 className="text-[#1C1C1C] text-3xl md:text-[42px] font-bold text-center md:text-start uppercase">Supply Distribution</h3>
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 my-4">
            ...
            <div>
              <div className="flex items-center gap-1">
                ...
                <p className="text-[#596E7F] text-sm">Locked Rewards (20M)</p>
              </div>
              <div className="flex items-center gap-1">
                <span className="w-3 h-3 bg-[#002540]"></span>
                <p className="text-[#596E7F] text-sm">Circulating (1M)</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 rounded-shadow border border-[#CFDCE5]">
            <h3 className="text-[#1C1C1C] text-3xl md:text-[42px] font-bold text-center md:text-start uppercase">Daily Pool Reduction</h3>
            <div className="my-4">

            <img loading="lazy" src="/tokenomics/chart.png" alt="chart" />
            <p className="text-[#596E7F] text-sm text-center mt-1">Daily reward pool decreases yearly to ensure sustainability</p>
            </div>
          </div>
      </div>
    </div>
