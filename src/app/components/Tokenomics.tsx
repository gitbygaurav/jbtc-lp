    ...
    <div className="w-full max-w-[1440px] mx-auto py-6 md:py-16 px-2 md:px-8">
      <div className="w-full tokenomics-gradient flex justify-between relative rounded-lg overflow-hidden shadow">
        <div className="flex flex-col justify-between px-5 md:px-10 py-8 md:py-12">
          <h1 className="text-3xl md:text-5xl font-elza-bold-condensed font-bold text-white uppercase mb-4">
            Tokenomics
          </h1>
          <div>
            <div>
              <p className="text-[#CFDCE5] text-sm font-satoshi-regular">Name</p>
              <p className="text-white text-xl md:text-3xl font-elza-bold-condensed font-bold">JBTC</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-elza-bold-condensed font-bold">21,000,000</p>
                ...
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-elza-bold-condensed font-bold">1,000,000</p>
                ...
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-elza-bold-condensed font-bold">45yrs</p>
              ...
              <div>
                <div className="md:mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-elza-bold-condensed font-bold">BSC</p>
                ...
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-elza-bold-condensed font-bold">20,000,000</p>
                    <p className="text-[#CFDCE5] font-satoshi-regular">JBTC</p>
                  </span>
                </div>
                <div className="mt-6">
                  ...
                  <span className="flex space-x-1 items-center">
                    <p className="text-white text-xl md:text-3xl font-elza-bold-condensed font-bold">5,000 </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-6">
        <div className="bg-white rounded-xl p-6 rounded-shadow border border-[#CFDCE5]">
          <h3 className="text-[#1C1C1C] text-3xl md:text-[42px] font-elza-bold-condensed font-bold text-center md:text-start uppercase">Supply Distribution</h3>
        ...
        <div className="bg-white rounded-xl p-6 rounded-shadow border border-[#CFDCE5]">
            <h3 className="text-[#1C1C1C] text-3xl md:text-[42px] font-elza-bold-condensed font-bold text-center md:text-start uppercase">Daily Pool Reduction</h3>
            <div className="my-4">
