const DailyRewards: React.FC = () => {
    return (
        <div className="w-full max-w-[1440px] mx-auto px-2 md:px-0">
            <h2 className="text-xl md:text-4xl text-center font-elza-bold font-bold mb-4">How to Earn Daily Rewards</h2>
            <p className="text-[#333333] text-center font-satoshi-medium">Simple steps to start earning passive income with JBTC</p>
