  ...
  return (
    <div className="w-full bg-[#1C1C1C] text-white">
      <div className="w-full max-w-[1440px] mx-auto py-6 md:py-16 px-2 md:px-8">
        ...
        <p className="text-lg text-[#FFFFFF] text-center font-medium mt-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="flex flex-col justify-between gap-4 md:gap-6">
            <div className="h-full bg-[#2D87F1] text-white px-6 py-10 rounded-xl">
              <p className="text-3xl md:text-5xl font-bold uppercase md:leading-14 mb-6 md:mb-0">
                No mining, No staking, Just hold & earn
              </p>
            </div>
            <div className="bg-white text-[#1C1C1C] pt-10 rounded-xl">
              <p className="text-3xl md:text-[42px] font-bold text-center md:text-start uppercase tracking-tight leading-14 pl-0 md:pl-6">
          ...
          <div className="bg-white text-[#1C1C1C] rounded-xl px-6 py-5">
            <h2 className="text-[#2D87F1] text-[120px] md:text-[200px] font-bold text-center tracking-tight mx-auto">
              PoH
            </h2>
            <p className="text-[25px] md:text-[38px] text-center font-bold uppercase tracking-tight md:leading-14 md:mt-14">
          ...
          <div className="flex flex-col justify-between gap-4 md:gap-6">
            <div className="bg-white text-[#1C1C1C] pl-6 pr-5 pt-10 pb-16 rounded-xl">
              <h2 className="text-3xl md:text-[42px] font-bold uppercase md:leading-14 mb-4">
                Strong potential for high returns
              </h2>
            </div>
            <div className="bg-white px-6 py-5 rounded-xl">
              <h2 className="text-black text-3xl md:text-[38px] font-bold uppercase tracking-tight md:leading-14">
